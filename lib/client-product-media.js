...
export function saveProductMediaRecord({ mediaId = null, payload }) {
...
export async function uploadProductMedia({
  ...
  const media = await saveProductMediaRecord({
    mediaId,
    payload: {
...
export function registerExternalProductMedia({
  mediaId = null,
  productId,
  campaignId = "",
  mediaType = "image",
  ...
  if (!productId || (!publicUrl && !storagePath)) {
    throw new Error("Informe o produto e uma mídia válida.");
  }
  return saveProductMediaRecord({
    mediaId,
    payload: {
      product_id: productId,
      campaign_id: campaignId || "",
