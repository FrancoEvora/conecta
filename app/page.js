...
export default async function HomePage() {
  ...
  return <><Header/><main>
    <section className="hero hero--commercial"><div className="container hero__grid"><div className="hero__copy"><span className="eyebrow desktop-hero-copy">Infraestrutura comercial para o mercado imobiliário</span><span className="eyebrow mobile-only">Rede de oportunidades com operação profissional</span><h1><span className="desktop-hero-copy">Relacionamentos podem gerar vendas.</span><span className="mobile-only">Boas conexões podem virar negócios.</span> <em>A Rede Conecta organiza todo o caminho.</em></h1><p className="desktop-hero-copy">Conectores originam oportunidades. A Rede Conecta atende, qualifica e conduz o processo. Empreendedores e corretores acompanham o que importa. A origem do negócio permanece registrada.</p><p className="mobile-only">Você faz a conexão. Nossa equipe atende, acompanha e conduz. Tudo fica registrado, com transparência e segurança.</p><div className="button-row"><Link href="/cadastro" className="button button--orange">Quero fazer parte da rede <Icon name="arrow"/></Link><Link href="/empreendedores" className="button button--navy">Quero gerar mais vendas</Link></div><div className="hero__trust"><span><Icon name="shield" size={18}/> Origem preservada</span><span><Icon name="headset" size={18}/> Atendimento conduzido</span><span><Icon name="chart" size={18}/> Resultado acompanhado</span></div></div><div className="hero__visual hero__visual--commercial"><div className="hero__badge"><b>O que é a Rede Conecta?</b><span>A infraestrutura que transforma relacionamento em oportunidade imobiliária rastreável — da indicação ao resultado.</span></div></div></div></section>

    <section className="commercial-definition"><div className="container"><span>EM UMA FRASE</span><strong>A Rede Conecta é um canal comercial estruturado que une pessoas, produtos e operação de vendas em uma única plataforma.</strong></div></section>
