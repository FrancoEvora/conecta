...
export function Header({ minimal = false }) {
  return <header className="site-header"><div className="container header__inner"><NetworkMark/>{!minimal && <nav className="header__nav" aria-label="Principal"><Link href="/conectores">Conectores</Link><Link href="/empreendedores">Empreendedores</Link><Link href="/corretores">Corretores</Link><Link href="/oportunidades">Oportunidades</Link></nav>}<div className="header__actions"><Link href="/entrar" className="text-link">Entrar</Link><Link href="/cadastro" className="button button--orange">Começar agora</Link></div></div></header>;
}

export function Footer() {
  return <footer className="footer"><div className="container footer__grid"><div><NetworkMark inverse/><p>A infraestrutura comercial que transforma relacionamentos em oportunidades imobiliárias rastreáveis.</p></div><div><strong>Para quem</strong><Link href="/conectores">Conectores</Link><Link href="/empreendedores">Empreendedores</Link><Link href="/corretores">Corretores</Link></div><div><strong>Plataforma</strong><Link href="/oportunidades">Oportunidades</Link><Link href="/entrar">Acessar painel</Link><Link href="/cadastro">Criar conta</Link></div><div><strong>Governança</strong><Link href="/privacidade">Privacidade</Link><Link href="/termos">Termos de uso</Link><Link href="/termos-parceiros">Termos dos parceiros</Link></div></div><div className="container footer__bottom"><span>© 2026 Rede Conecta.</span><span>Relacionamento com infraestrutura comercial.</span></div></footer>;
}
